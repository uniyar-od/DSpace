...
public class RelationshipTypeRelationshipLinkRepository extends AbstractDSpaceRestRepository
    ...
    @PreAuthorize("hasPermission(#relationshipId, 'RELATIONSHIP', 'READ')")
    public Page<RelationshipTypeRest> getRelationshipType(@Nullable HttpServletRequest request,
        ...
        try {
            ...
            return converter.toRestPage(List.of(relationshipType), pageable, total, projection);
