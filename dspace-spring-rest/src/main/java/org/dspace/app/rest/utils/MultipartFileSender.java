...
public class MultipartFileSender {
        ...
        if (isNullOrEmpty(disposition)) {
            if (contentType == null) {
                ...
                disposition = accept != null && accepts(accept,
                    contentType) ? CONTENT_DISPOSITION_INLINE : CONTENT_DISPOSITION_ATTACHMENT;
            }
    ...
    private static class Range {
        ...
        private static List<Range> relativize(List<Range> ranges) {
            ...
            for (Range r : ranges) {
                Range newRange =
                    isNull(prevRange) ? r : new Range(r.start - prevRange.end - 1, r.end - prevRange.end - 1, r.total);
