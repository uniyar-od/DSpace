...
public class SearchFacetValueHalLinkFactory extends DiscoveryRestHalLinkFactory<SearchFacetValueResource> {
    ...
    protected void addLinks(SearchFacetValueResource halResource, Pageable pageable, LinkedList<Link> list)
        ...
        if (halResource.getSearchData() != null && halResource.getFacetData() != null &&
            halResource.getValueData() != null) {
    ...
    private void addFilterForFacetValue(final UriComponentsBuilder baseLink, SearchFacetEntryRest facetData,
                                        SearchFacetValueRest valueData) {
