...
public class SpecialGroupClaimProviderTest {
    ...
    public void setUp() throws Exception {
        ...
        jwtClaimsSet = new JWTClaimsSet.Builder().claim(SpecialGroupClaimProvider.SPECIAL_GROUPS, groupIds).build();
    }
    ...
    public void parseClaim() throws Exception {
        ...
        assertThat(specialGroups, containsInAnyOrder(UUID.fromString(id1), UUID.fromString(id2), UUID.fromString(id3)));
