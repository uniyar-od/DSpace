...
public abstract class AbstractDSpaceObjectBuilder<T extends DSpaceObject>
    ...
    protected <B extends AbstractDSpaceObjectBuilder<T>> B setOnlyReadPermission(DSpaceObject dso, Group group,
        ...
        try {
            ...
            ResourcePolicy rp = authorizeService
                .createOrModifyPolicy(null, context, null, group, null, startDate, Constants.READ, "Integration Test",
                    dso);
            if (rp != null) {
    ...
    protected <B extends AbstractDSpaceObjectBuilder<T>> B setRemovePermissionForEperson(DSpaceObject dso,
            EPerson eperson, Date startDate) {
        try {

            ResourcePolicy rp = authorizeService.createOrModifyPolicy(null, context, null, null, eperson, startDate,
                    Constants.REMOVE, "Integration Test", dso);
            if (rp != null) {
    ...
    protected <B extends AbstractDSpaceObjectBuilder<T>> B setAddPermissionForEperson(DSpaceObject dso, EPerson eperson,
            Date startDate) {
        try {

            ResourcePolicy rp = authorizeService.createOrModifyPolicy(null, context, null, null, eperson, startDate,
                    Constants.ADD, "Integration Test", dso);
            if (rp != null) {
    ...
    protected <B extends AbstractDSpaceObjectBuilder<T>> B setWritePermissionForEperson(DSpaceObject dso,
        ...
        try {
            ...
            ResourcePolicy rp = authorizeService.createOrModifyPolicy(null, context, null, null, eperson, startDate,
                    Constants.WRITE, "Integration Test", dso);
            if (rp != null) {
