  ...
  <div class="tab-pane <%= i==0?"active":""%>" id="<%= keyID %>" role="tabpanel" aria-labelledby="<%= keyID %>-tab">
    <div class="row">
      <div class="col-md-12">
		...
		List<IMetadataValue> requestPendings = item.getMetadataValueInDCFormat("local.message.claim");
		for(IMetadataValue requestPending : requestPendings) {
		    String vvv = requestPending.getValue();
