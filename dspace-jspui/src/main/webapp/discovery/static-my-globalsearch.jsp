    ...
    jQuery(document)
            .ready(
                    function() {
                        ...
                        jQuery(
                                "#searchglobalprocessor .search-panel .dropdown-menu li a")
                                .click(
                                        function() {
                                ...
                                .popover(
                                        {
                                            ...
                                            title : function() {
                                                return jQuery(
                                                        '#group-left-info-popover-head')
                                                        .html();
                                            },
                                            content : function() {
                                                return jQuery(
                                                        '#group-left-info-popover-content')
                                                        .html();
                                            }
                                        });
                                ...
                                .popover(
                                        {
                                            ...
                                            title : function() {
                                                return jQuery(
                                                        '#group-center-info-popover-head')
                                                        .html();
                                            },
                                            content : function() {
                                                return jQuery(
                                                        '#group-center-info-popover-content')
                                                        .html();
                                            }
                                        });
                                ...
                                .popover(
                                        {
                                            ...
                                            title : function() {
                                                return jQuery(
                                                        '#group-right-info-popover-head')
                                                        .html();
                                            },
                                            content : function() {
                                                return jQuery(
                                                        '#group-right-info-popover-content')
                                                        .html();
                                            }
                                        });
...
<%
    ...
    List<DiscoverySearchFilterFacet> facetsGlobalConf = (List<DiscoverySearchFilterFacet>) request
            .getAttribute("facetsGlobalConfig");
    Map<String, List<FacetResult>> mapGlobalFacetes = (Map<String, List<FacetResult>>) request
            .getAttribute("discovery.global.fresults");

    Map<String, String> mapFacetFirstLevel = (Map<String, String>) request
            .getAttribute("facetGlobalFirstLevel");
    Map<String, String> mapFacetSecondLevel = (Map<String, String>) request
            .getAttribute("facetGlobalSecondLevel");
%>

<div class="row">
    <form id="searchglobalprocessor" name="searchglobalprocessor"
        class="col-md-6 col-md-offset-3"
        action="<%=request.getContextPath()%>/simple-search" method="get">
        <div class="input-group">
            <input type="text" class="form-control" name="query"
                placeholder="<fmt:message key="jsp.layout.navbar-default.search"/>">
            <span class="input-group-btn">
                <button class="btn btn-primary globalsearch" type="submit">
            ...
            <div class="input-group-btn search-panel">
                ...
                <ul class="dropdown-menu menu-global-processor dropdown-small" role="menu">
                    ...
                    <li class="menu-global-processor"><a href="#"
                        title="<%=fvalue.getAuthorityKey()%>"><span
                            class="badge pull-right"><%=fvalue.getCount()%></span> <%=StringUtils.abbreviate(fvalue.getDisplayedValue(), 36)%>
...
<div id="group-left-info-popover-content" class="hide">
    <ul class="list-group">
        ...
        <li class="list-group-item"><span class="badge"><%=fvalue.getCount()%></span>
            <a
            href="<%=request.getContextPath()%>/simple-search?query=&location=<%=fvalue.getAuthorityKey()%>"><fmt:message
                    key="<%=fkey%>" /></a></li>
        <%
            }
                            }
        ...
        %>
        <li role="presentation" class="dropdown-header"><fmt:message
                key="jsp.home.group.dropdown.header.secondlevel" /></li>
        <%
            List<FacetResult> facet = mapGlobalFacetes.get(f);
                            if (facet != null) {
                                for (FacetResult fvalue : facet) {
        ...
        <li class="list-group-item"><span class="badge"><%=fvalue.getCount()%></span>
            <a
            href="<%=request.getContextPath() + "/simple-search?filterquery="
                                            + URLEncoder.encode(fvalue.getAsFilterQuery(), "UTF-8") + "&amp;filtername="
                                            + URLEncoder.encode(f, "UTF-8") + "&amp;filtertype="
                                            + URLEncoder.encode(fvalue.getFilterType(), "UTF-8")%>"
