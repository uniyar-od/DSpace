...
public class SubmissionInfo extends HashMap
{
    ...
    private final static SubmissionStepConditionCheck conditionCheck = new DSpace().getServiceManager().getServiceByName("SubmissionStepConditionCheck",SubmissionStepConditionCheck.class);
