...
public class AuthorityLookupModifierAdvanced<T extends ACrisObject>
     ...
     * @param crisObjects the list of results
        ...
        try {
            ...
            for (String value : values) {
                ...
                if (StringUtils.isNotBlank(value)) {
                    ...
                    if (choiceValues != null && choiceValues.length == 1) {
