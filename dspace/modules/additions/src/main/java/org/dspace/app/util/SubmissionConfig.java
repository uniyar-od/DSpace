...
public class SubmissionConfig implements Serializable
{
	...
	private final SubmissionStepConditionCheck conditionCheck = new DSpace().getServiceManager().getServiceByName("SubmissionStepConditionCheck",SubmissionStepConditionCheck.class);
