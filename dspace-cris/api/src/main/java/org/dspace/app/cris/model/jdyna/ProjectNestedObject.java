...
@NamedQueries( {
        ...
        @NamedQuery(name = "ProjectNestedObject.paginateNestedObjectsByParentIDAndTypoID.positiondef.asc", query = "from ProjectNestedObject where parent.id = ? and typo.id = ? order by positiondef asc"),
        @NamedQuery(name = "ProjectNestedObject.paginateNestedObjectsByParentIDAndTypoID.positiondef.desc", query = "from ProjectNestedObject where parent.id = ? and typo.id = ? order by positiondef desc"),
        ...
        @NamedQuery(name = "ProjectNestedObject.paginateActiveNestedObjectsByParentIDAndTypoID.positiondef.asc", query = "from ProjectNestedObject where parent.id = ? and typo.id = ? and status = true order by positiondef asc"),
        @NamedQuery(name = "ProjectNestedObject.paginateActiveNestedObjectsByParentIDAndTypoID.positiondef.desc", query = "from ProjectNestedObject where parent.id = ? and typo.id = ? and status = true order by positiondef desc"),
