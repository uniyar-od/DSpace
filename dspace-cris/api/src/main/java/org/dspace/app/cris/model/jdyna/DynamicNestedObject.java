...
@NamedQueries({
        ...
        @NamedQuery(name = "DynamicNestedObject.paginateNestedObjectsByParentIDAndTypoID.positiondef.asc", query = "from DynamicNestedObject where parent.id = ? and typo.id = ? order by positiondef asc"),
        @NamedQuery(name = "DynamicNestedObject.paginateNestedObjectsByParentIDAndTypoID.positiondef.desc", query = "from DynamicNestedObject where parent.id = ? and typo.id = ? order by positiondef desc"),
        ...
        @NamedQuery(name = "DynamicNestedObject.paginateActiveNestedObjectsByParentIDAndTypoID.positiondef.asc", query = "from DynamicNestedObject where parent.id = ? and typo.id = ? and status = true order by positiondef asc"),
        @NamedQuery(name = "DynamicNestedObject.paginateActiveNestedObjectsByParentIDAndTypoID.positiondef.desc", query = "from DynamicNestedObject where parent.id = ? and typo.id = ? and status = true order by positiondef desc"),
