...
@NamedQueries( {
    ...
    @NamedQuery(name = "RPPropertiesDefinition.likeAllWithPolicySingle", query = "from RPPropertiesDefinition where shortName LIKE :par0 and rendering in (from WidgetEPerson)"),
    @NamedQuery(name = "RPPropertiesDefinition.likeAllWithPolicyGroup", query = "from RPPropertiesDefinition where shortName LIKE :par0 and rendering in (from WidgetGroup)"),
