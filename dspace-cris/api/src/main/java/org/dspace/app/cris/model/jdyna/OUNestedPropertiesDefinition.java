...
@NamedQueries( {
    ...
    @NamedQuery(name = "OUNestedPropertiesDefinition.likeAllWithPolicySingle", query = "from OUNestedPropertiesDefinition where shortName LIKE :par0 and rendering in (from WidgetEPerson)"),
    @NamedQuery(name = "OUNestedPropertiesDefinition.likeAllWithPolicyGroup", query = "from OUNestedPropertiesDefinition where shortName LIKE :par0 and rendering in (from WidgetGroup)"),
