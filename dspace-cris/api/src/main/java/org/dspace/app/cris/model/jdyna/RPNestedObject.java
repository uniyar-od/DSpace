...
@NamedQueries({
        ...
        @NamedQuery(name = "RPNestedObject.paginateNestedObjectsByParentIDAndTypoID.positiondef.asc", query = "from RPNestedObject where parent.id = ? and typo.id = ? order by positiondef asc"),
        @NamedQuery(name = "RPNestedObject.paginateNestedObjectsByParentIDAndTypoID.positiondef.desc", query = "from RPNestedObject where parent.id = ? and typo.id = ? order by positiondef desc"),
        ...
        @NamedQuery(name = "RPNestedObject.paginateActiveNestedObjectsByParentIDAndTypoID.positiondef.asc", query = "from RPNestedObject where parent.id = ? and typo.id = ? and status = true order by positiondef asc"),
        @NamedQuery(name = "RPNestedObject.paginateActiveNestedObjectsByParentIDAndTypoID.positiondef.desc", query = "from RPNestedObject where parent.id = ? and typo.id = ? and status = true order by positiondef desc"),
