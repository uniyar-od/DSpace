...
@NamedQueries( {
    ...
    @NamedQuery(name = "OUPropertiesDefinition.likeAllWithPolicySingle", query = "from OUPropertiesDefinition where shortName LIKE :par0 and rendering in (from WidgetEPerson)"),
    @NamedQuery(name = "OUPropertiesDefinition.likeAllWithPolicyGroup", query = "from OUPropertiesDefinition where shortName LIKE :par0 and rendering in (from WidgetGroup)"),
