...
public class OrcidPubmedQueryGenerator extends AFeedQueryGenerator {

    Logger log = Logger.getLogger(OrcidPubmedQueryGenerator.class);
    ...
    public HashMap<UUID, List<String>> generate(Context context) {
        ...
        try {
            ...
            while(iter.hasNext()) {
                ...
                buffer.append(orcid+"[Author - Identifier]");
