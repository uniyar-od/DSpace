...
@NamedQueries( {
        ...
        @NamedQuery(name = "OUNestedObject.paginateNestedObjectsByParentIDAndTypoID.positiondef.asc", query = "from OUNestedObject where parent.id = ? and typo.id = ? order by positiondef asc"),
        @NamedQuery(name = "OUNestedObject.paginateNestedObjectsByParentIDAndTypoID.positiondef.desc", query = "from OUNestedObject where parent.id = ? and typo.id = ? order by positiondef desc"),
        ...
        @NamedQuery(name = "OUNestedObject.paginateActiveNestedObjectsByParentIDAndTypoID.positiondef.asc", query = "from OUNestedObject where parent.id = ? and typo.id = ? and status = true order by positiondef asc"),
        @NamedQuery(name = "OUNestedObject.paginateActiveNestedObjectsByParentIDAndTypoID.positiondef.desc", query = "from OUNestedObject where parent.id = ? and typo.id = ? and status = true order by positiondef desc"),
