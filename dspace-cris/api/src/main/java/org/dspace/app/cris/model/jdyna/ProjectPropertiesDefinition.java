...
@NamedQueries( {
    ...
    @NamedQuery(name = "ProjectPropertiesDefinition.likeAllWithPolicySingle", query = "from ProjectPropertiesDefinition where shortName LIKE :par0 and rendering in (from WidgetEPerson)"),
    @NamedQuery(name = "ProjectPropertiesDefinition.likeAllWithPolicyGroup", query = "from ProjectPropertiesDefinition where shortName LIKE :par0 and rendering in (from WidgetGroup)"),
