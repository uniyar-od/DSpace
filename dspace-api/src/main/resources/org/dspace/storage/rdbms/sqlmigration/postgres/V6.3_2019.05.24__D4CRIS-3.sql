...
ALTER TABLE imp_record ADD COLUMN imp_eperson_id UUID;
ALTER TABLE imp_record ADD COLUMN imp_collection_id UUID;
...
ALTER TABLE imp_record_to_item ADD COLUMN imp_item_id UUID;
