...
public class Event implements Serializable {
    ...
    public UsageEventEntity getObject(Context context) throws SQLException {
        ...
        if (type < 0 || id == null) {
            ...
            return (UsageEventEntity) ContentServiceFactory.getInstance().getDSpaceObjectService(type)
                                                           .find(context, id);
        }
    }
    ...
    public UsageEventEntity getSubject(Context context) throws SQLException {
        return (UsageEventEntity) ContentServiceFactory.getInstance().getDSpaceObjectService(getSubjectType())
