...
public class GenerateSitemaps
{
    ...
    public static void generateSitemaps(boolean makeHTMLMap,
        ...
        String sitemapStem = configurationService.getProperty("dspace.url") + "/sitemap";
        String htmlMapStem = configurationService.getProperty("dspace.url") + "/htmlmap";
...
//        }
    ...
    public static void pingConfiguredSearchEngines() throws UnsupportedEncodingException {
		...
		String[] engineURLs = configurationService.getArrayProperty("sitemap.engineurls");
	...
	public static void pingSearchEngine(String engineURL) throws MalformedURLException, UnsupportedEncodingException {
		...
		if ((StringUtils.isNotBlank(configurationService.getProperty("http.proxy.host")))
			...
			System.setProperty("proxyHost", configurationService.getProperty("http.proxy.host"));
			System.getProperty("proxyPort", configurationService.getProperty("http.proxy.port"));
		}

		String sitemapURL = configurationService.getProperty("dspace.url") + "/sitemap";
