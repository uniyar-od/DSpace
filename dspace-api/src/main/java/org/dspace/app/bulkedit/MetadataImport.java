            ...
            if (id != null) {
                ...
                if (applyAuthCollection) {
                    ...
                    ContentServiceFactory.getInstance().getItemService()
                                         .replaceAllItemPolicies(this.c, item, newpolicies);
                    ContentServiceFactory.getInstance().getItemService()
                                         .replaceAllBitstreamPolicies(this.c, item, newpolicies);
                }
                ...
                for (Collection collection : item.getCollections()) {
                    ...
                    if (applyAuthCollection) {
                        ContentServiceFactory.getInstance().getItemService()
                                             .inheritCollectionDefaultPolicies(this.c, item, collection);
                    }
                }
