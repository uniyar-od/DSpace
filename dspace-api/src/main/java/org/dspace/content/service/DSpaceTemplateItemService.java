        ...
        for (IMetadataValue md : mds) {
            ...
            if (StringUtils.startsWith(md.getValue(), "###")
                ...
                if (gen != null) {
                    ...
                    List<IMetadataValue> genMetadata = gen
                        .generator(context, targetItem, templateItem, md, extraParams);
                    for (IMetadataValue gm : genMetadata) {
                        targetItem.getItemService()
                                  .addMetadata(context, targetItem, gm.getSchema(), gm.getElement(), gm.getQualifier(),
                                               gm.getLanguage(),
            ...
            targetItem.getItemService()
                      .addMetadata(context, targetItem, md.getSchema(), md.getElement(), md.getQualifier(),
                                   md.getLanguage(),
