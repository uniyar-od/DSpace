...
public interface DisseminationCrosswalk {
     ...
     * Note that, if the implementing class is of type
     * "{@link org.dspace.content.crosswalk.ContextAwareDisseminationCrosswalk}"
     * and a context is present in the method call, you should set the context before calling this method. -> "{@link
     * org.dspace.content.crosswalk.ContextAwareDisseminationCrosswalk#setContext(org.dspace.core.Context)}"
     * The implementing class should then use the  "{@link ContextAwareDisseminationCrosswalk#getContext()}" and
     * "{@link ContextAwareDisseminationCrosswalk#handleContextCleanup()}" to retrieve and commit/complete the
