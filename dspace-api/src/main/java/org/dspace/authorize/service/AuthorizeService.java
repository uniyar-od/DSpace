...
public interface AuthorizeService {
     ...
     */
    public void addPolicy(Context c, AuthorizableEntity o, int actionID, EPerson e)
     ...
     * @throws AuthorizeException if current user in context is not authorized to add policies
     */
    public void addPolicy(Context c, AuthorizableEntity o, int actionID, EPerson e, String type)
        throws SQLException, AuthorizeException;
     ...
     */
    public void addPolicy(Context c, AuthorizableEntity o, int actionID, Group g)
        throws SQLException, AuthorizeException;
     ...
     * @throws AuthorizeException if the current user is not authorized to add this policy
     */
    public void addPolicy(Context c, AuthorizableEntity o, int actionID, Group g, String type)
        throws SQLException, AuthorizeException;
     ...
     * @throws SQLException if there's a database problem
     */
    public List<ResourcePolicy> getPoliciesActionFilter(Context c, AuthorizableEntity o, int actionID)
        throws SQLException;
     ...
     */
    public void inheritPolicies(Context c, AuthorizableEntity src, AuthorizableEntity dest)
        throws SQLException, AuthorizeException;
     ...
     * @throws SQLException if there's a database problem
     */
    public boolean isAnIdenticalPolicyAlreadyInPlace(Context c, AuthorizableEntity o, Group group, int actionID,
     ...
     * @throws AuthorizeException if authorization error
     */
    public void generateAutomaticPolicies(Context context, Date embargoDate, String reason, AuthorizableEntity dso,
    ...
    public ResourcePolicy createOrModifyPolicy(ResourcePolicy policy, Context context, String name, Group group,
                                               ...
                                               AuthorizableEntity dso) throws AuthorizeException, SQLException;
