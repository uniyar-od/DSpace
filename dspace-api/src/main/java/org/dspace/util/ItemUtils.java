...
public class ItemUtils {
    ...
    public static void removeOrWithdrawn(Context context, Item item)
        ...
        if (item.getHandle() != null) {
            ...
            // Delete wrapper
            if (inprogress != null) {
                ContentServiceFactory.getInstance().getInProgressSubmissionService(inprogress)
                                     .deleteWrapper(context, inprogress);
            }
    ...
    public static String getSubmissionFormName(Item current) throws SubmissionConfigReaderException {
        ...
        if (current.getOwningCollection() != null) {
            return submissionConfigReader.getSubmissionConfigByCollection(current.getOwningCollection().getHandle())
                                         .getSubmissionName();
        }
