...
public class DatabaseUtils
{
    ...
    public static void main(String[] argv)
    {
        ...
        if (argv.length < 1)
        {
            ...
            System.out.println("Valid actions: 'test', 'info', 'migrate', 'repair', 'validate', 'clean', 'update-sequences', 'install-example-cris-base'");
        ...
        try
        {
            ...
            else
            {
				...
				System.out.println("Valid actions: 'test', 'info', 'migrate', 'repair', 'update-sequences', install-example-cris-base or 'clean'");
